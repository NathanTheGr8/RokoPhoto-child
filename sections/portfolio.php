...
$rokophoto_portfolio_link_to_single = get_theme_mod('rokophoto_portfolio_link_to_single');
...
?>
    ...
    <!-- Portfolio Title -->
      <div class="light-overlay ptitle<?php if( $rokophoto_portfolio_display_settings == 1 && isset($wp_customize) ) { echo ' rokophoto_only_customizer'; } ?>">
    ...
    <section id="portfolio" class="grid<?php if( $rokophoto_portfolio_display_settings == 1 && isset($wp_customize) ) { echo ' rokophoto_only_customizer'; } ?>">
	...
	<?php if ( $loop->have_posts() ): ?>
		...
		<?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
			<?php
			if( isset($rokophoto_portfolio_link_to_single) && $rokophoto_portfolio_link_to_single == 1){
				$portfolio_link = get_the_permalink();
			} else {
				$portfolio_link = '#portfolioModa'.get_the_ID();
			}
			...
			<figure class="effect-portfolio wow fadeIn" data-wow-duration="1s"> <!-- Portfolio -->
				...
				<figcaption> <!-- Caption -->
					...
					<a href="<?php echo $portfolio_link; ?>" class="portfolio-link" data-toggle="modal" data-id="<?php the_ID(); ?>"><?php _e( 'View More', 'rokophoto' ); ?></a>
